...
The data we are going to be using is "Youth Risk Behavior Surveillance System (YRBSS): High School – Excluding Sexual Identity". This data has a wide range of variables and entries from 1991-2017 that monitored young peoples behaviors (violence; tobacco use; substance abuse; sexual health; dietary health; and physical health).
