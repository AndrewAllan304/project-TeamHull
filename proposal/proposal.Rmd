...
Weight_Issues_Edited %>%
  ...
  ggplot(aes(x = LocationDesc , y = Pop_at_Grisk, colour = LocationDesc)) +
  geom_line() +
  theme(axis.text.x = element_text(angle = 90, size = 5), legend.position = "None", axis.title.x = element_text("Location"), axis.title.y = element_text("Population at Greater Risk"))
```
