...
Substance_Abuse_Edited <- Substance_Abuse %>%
  mutate(Pop_at_Grisk = Greater_Risk_Data_Value + Sample_Size)


```

>>>>>>> ff18bb5d3a2e579b6d296b468d25a294102f14c3
...
ggplot(aes(x=Grade, fill=Sex)) +
  geom_bar()
```
This graph shows the ammount of each grade that is represented on this list of Substance Abuse related events grouping by Sex. This shows a fairly even split between male and females.
