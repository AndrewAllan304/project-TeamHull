...
The data sets where created on August 29th 2016 and were last updated March 29th 2019. Therefore the data has a good range across 26 years period from 1991-2017 so we can visualize and evaluate trends in substance abuse and weight issues.

We imported the 2 data sheets and scanned over the data to see what variables can be used to produce interesting graphs, what variables are useful to us, and how this data proves things that are said media about these topics. 
