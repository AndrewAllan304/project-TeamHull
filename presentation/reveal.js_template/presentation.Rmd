...
author: <font size='8'>Team Hull <br> Names of team members</font>
...
substance_abuse <- read_csv("/cloud/project/data/Substance Abuse.csv")
weight_issues <- read_csv("/cloud/project/data/Weight Issues.csv")
```

## Wagwan. The goal of this presentation is to discover whether risky behaviour may appear more or less frequently among different categorical variables such as sex, geography, etc. {data-background-image="img/confetti.jpg"}
...
ggplot(weight_issues, aes(x = Grade, y = Sex, color = "YEAR")) +
  geom_line()
```
::::
:::
